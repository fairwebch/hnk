...
const dsDe = [
  ...
  LI('Statistik: anonymisierte Besucherstatistik (Google Analytics, siehe Ziff. 10). Wird nur mit Ihrer Einwilligung geladen.'),
  LI('Externe Inhalte: Inhalte von Drittanbietern, z. B. die Google Karte auf der Kontaktseite (siehe Ziff. 11). Werden nur mit Ihrer Einwilligung geladen.'),
  ...
  H3('12. Externe Links und Vereinsshop'),
...
const dsHr = [
  ...
  LI('Statistika: anonimizirana statistika posjeta (Google Analytics, vidi t. 10). Učitava se samo uz vašu privolu.'),
  LI('Vanjski sadržaj: sadržaj trećih strana, npr. Google karta na kontakt stranici (vidi t. 11). Učitava se samo uz vašu privolu.'),
  ...
  H3('12. Vanjske poveznice i klupski shop'),
